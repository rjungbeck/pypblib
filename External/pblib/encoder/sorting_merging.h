...
namespace PBLib
{
  class Sorting
  {
    ...
    private:
      ...
      static void comparator(const int32_t x1, const int32_t x2, const int32_t y1, const int32_t y2, ClauseDatabase & formula, ImplicationDirection direction);
      static void comparator(const int32_t x1, const int32_t x2, const int32_t y1, ClauseDatabase & formula, ImplicationDirection direction);
