...
Logic Optimization Group @ University of Lleida * Carlos Ansótegui * Toni Pacheco * Josep Pon

## Requirements

The only requirement is a C/C++ compiler with C++11 support that can be accessed by distutil/setuptools.
